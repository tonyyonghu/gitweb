...
<![endif]-->
<script type="text/javascript" src="/view/js/news.js"></script>
</head>
<div id="adtop"></div>
<script type="text/javascript" src="/view/js/content.js"></script>
<body>
    <h1></h1>
...
<p class="link">
    ...
    <dl class="texts">
        <dt>请返回网站首页搜索您需要的内容：<a href="/" target="_blank">首页</a></dt>
        <dd>
            <ul>
                <li>不要返回吗?</li>
                <li>确定不要返回吗?</li>
